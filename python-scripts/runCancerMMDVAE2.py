...
if __name__ == '__main__':
    ...
    # data_dir_list=[ 'data/cancer/breast','data/cancer/kidney','data/cancer/lung','data/cancer/ovarian']
    # result_dir_list=['result/cancer/breast','result/cancer/kidney','result/cancer/lung','result/cancer/ovarian']
    data_dir_list = ['data/cancer/breast']
    result_dir_list = ['result/cancer/breast']
