...
def build_NN_model1(omics,class_num):
    ...
    # NN
    omics1_nn = Dense(100, activation='relu')(input_factor1)
    ...
    # NN
    omics2_nn = Dense(100, activation='relu')(input_factor2)
    ...
    # NN
    omics3_nn = Dense(100, activation='relu')(input_factor2)
...
if __name__ == '__main__':
    ...
    typenums=[5,10,15]
    noise_factor=0.5
    savepath='./result/simulations/lfnn_res1.txt'
    ...
    # typenums=[5,10,15]
    # noise_factor=0.5
    # savepath='./result/simulations/efnn_res1.txt'
    # with open(savepath, 'w') as f2:
    #     for datatype in datatypes:
    #         f2.write(datatype+'\n')
    #         for typenum in typenums:
