...
class ZVAE:
    def __init__(self,original_dims):
        ...
        # self.o2_nn2_dim=100
        # #组学三编码器维度
        # self.o3_original_dim=original_dims[2]
        # self.o3_nn1_dim=300
        # self.o3_nn2_dim=100
        ...
        #组学三编码器
        self.omics3 = Input(shape=(self.o3_original_dim,),name='input_omics3')
        self.o3_encoder = Dense(self.o3_nn1_dim, name='o3_encoder_layer1', activation=acti, kernel_regularizer=regularizers.l2(self.reg_lambda))(self.omics3)
        self.o3_encoder = Dense(self.o3_nn2_dim, name='o3_encoder_layer2', activation=acti, kernel_regularizer=regularizers.l2(self.reg_lambda))(self.o3_encoder)
        #三个组学中间输出拼接
        self.concat = Concatenate(axis=-1, name='concat_layer')([self.o1_encoder, self.o2_encoder,self.o3_encoder])
        ...
        #组学三解码器
        self.o3_decoder = Dense(self.o3_nn2_dim, name='o3_decoder_layer2', activation=acti, kernel_regularizer=regularizers.l2(self.reg_lambda))(self.z)
        self.o3_decoder = Dense(self.o3_nn1_dim, name='o3_decoder_layer1', activation=acti, kernel_regularizer=regularizers.l2(self.reg_lambda))(self.o3_decoder)
        self.o3_decoded = Dense(self.o3_original_dim, name='o3_decoded', activation=acti, kernel_regularizer=regularizers.l2(self.reg_lambda))(self.o3_decoder)

        #构造整个自编码器模型
        self.autoencoder = Model(inputs=[self.omics1, self.omics2,self.omics3], outputs=[self.o1_decoded,self.o2_decoded,self.o3_decoded])
        #kl散度损失函数
        ...
        self.autoencoder.compile(optimizer=Adam(1e-5),loss=['mse','mse',vae_loss_mmd])
        # print(self.autoencoder.summary())
        self.encoder = Model(inputs=[self.omics1, self.omics2,self.omics3],outputs=self.z_mean)
